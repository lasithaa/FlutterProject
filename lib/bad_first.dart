...
class badFirstPage extends StatefulWidget {
  const badFirstPage({Key? key}) : super(key: key);

  @override
  State<badFirstPage> createState() => _badFirstPageState();
}

class _badFirstPageState extends State<badFirstPage> {
